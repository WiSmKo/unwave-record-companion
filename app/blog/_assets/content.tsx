...
export const articles: articleType[] = [
  {
    ...
    title: "Introducing Supabase to Unwave",
    // The description of the article to display in the article page. Up to 160 characters. It's also used to generate the meta description.
    description:
      "Supabase is an open-source Firebase alternative. It's a great tool for building a backend for your app. It's now integrated with Unwave!",
    ...
    image: {
      ...
      alt: "Supabase and Unwave logo combined",
    },
  ...
  CONSTRAINT users_pkey PRIMARY KEY (id)
        ...
        <section>
          <h3 className={styles.h3}>2. Add your credentials to Unwave</h3>
          <p className={styles.p}>
            Copy the <span className={styles.codeInline}>API URL</span> and{" "}
            <span className={styles.codeInline}>API Key</span> from your
            Supabase project settings and add them to your Unwave project
